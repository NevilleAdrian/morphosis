             ...
             <div className="transparent"></div>
                 ...
                 <div className={showNav ? "overlay-fixed" : "overlay"}>
                     <div className="pt-3 pl-4 mb-5 pr-5">
                         ...
                         <a style={{color: "white"}} href={'https://dropinbutton-sandbox.vpay.africa/service/pay?amount='+ calculateItems + '&domain=sandbox&key=fdcdb195-6553-4890-844c-ee576b7ea715&transactionref=a4b2-133klklj43ddd4'+  (Math.floor(Math.random() * 25) + 1)  + '-%2078da&customer_service_channel=support@vpay.africa,%20+2348191000800&txn_charge_type=percentage&txn_charge=1.5'}>
